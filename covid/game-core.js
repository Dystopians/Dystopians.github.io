(function (root, factory) {
  ...
  const EVENT_BLUEPRINTS = [
    ...
    [
      ...
      e("li_wenliang_death", "李文亮医生去世", ["trust", "medical", "public"], "hospital", "武汉李文亮医生去世的消息传到临江，医院群聊、居民群和指挥部值班室都安静了几分钟。他曾因早期提醒而被训诫，如今又在一线感染后离世。临江市民开始把第一号通告、医护预警和信息公开重新连成一条线：如果真实提醒被压低，城市还会错过什么。", "李文亮医生去世、国家监委调查组赴武汉和武汉市政府哀悼通告", [
